...
- Showcases integration of LLMs with external tools and structured outputs  

---

## 📬 Notes
This project highlights how LLM-powered agents can automate repetitive workflows by combining reasoning, tool usage, and structured outputs.
